...
import LinkRounded from "@/app/components/LinkRounded";
...
function Rounded() {
  ...
  const itemClasses = {
    ...
    trigger:
      "px-2 py-0 data-[hover=true]:bg-default-100 rounded-md h-14 flex items-center",
  ...
  return (
    <>
      ...
      <div className="   w-full flex justify-center  mt-24">
        <div className="absolute  p-1 rounded-md bg-[#111111]">
          <Image
            width={900}
            height={900}
          ...
          <div>
            ...
            <div>
              <p className="font-Intermedium text-neutral-500 text-center my-3">
                Joscript is a software designer and content creator based in New
                Zealand.
              </p>
            ...
            <div className="mt-5">{path === "/rounded" && <LinkRounded />}</div>
            <div>
              <div className="bg-[#161616] gap-x-6 p-2.5 rounded-md mt-8 flex justify-between items-center hover:bg-neutral-800 duration-150 ease-out cursor-pointer ">
                <Image
                  width={900}
                  height={900}
                  className="w-10 h-9 rounded-md object-cover"
                  src="/images/f.jpg"
                  alt=""
                />
              ...
              <div className="bg-[#161616] gap-x-6 p-2.5 rounded-md mt-2 flex justify-between items-center hover:bg-neutral-800 duration-150 ease-out cursor-pointer">
                <Image
                  width={900}
                  height={900}
                  className="w-10 h-9 rounded-md object-cover"
            ...
            >
              <AccordionItem
                ...
                className={`text-white  bg-[#161616] rounded-md
                } px-3 hover:bg-neutral-800 duration-150 ease-out cursor-pointer`}
              ...
              <AccordionItem
                ...
                className="text-white  bg-[#161616]  rounded-md mt-2 px-3  hover:bg-neutral-800 duration-150 ease-out cursor-pointer"
                title="Latest Video"
              >
                <YouTube
                  videoId="p69xC3CW7WQ"
              ...
              <AccordionItem
                ...
                className="text-white bg-[#161616]  rounded-md mt-2 px-3 hover:bg-neutral-800 duration-150 ease-out cursor-pointer"
                startContent={<PiImagesThin className="text-warning" />}
              ...
              <AccordionItem
                ...
                className="text-white  bg-[#161616]  rounded-md mt-2 px-3 hover:bg-neutral-800 duration-150 ease-out cursor-pointer"
                startContent={<PiShoppingCart className="text-danger" />}
                subtitle="Store"
              >
                <Store />
              </AccordionItem>
              <AccordionItem
                ...
                aria-label="Card expired"
                className="text-white  bg-[#161616]  rounded-md mt-2 px-3 hover:bg-neutral-800 duration-150 ease-out cursor-pointer"
                startContent={<PiMusicNotesThin className="text-danger" />}
      ...
      >
        <div className="max-w-md  bg-[#161616] py-3 px-3 rounded-md">
      ...
      >
        <div className="max-w-md  bg-[#161616] py-3 px-3 rounded-md">
          ...
          <form action="">
            <input
              className="bg-neutral-800 rounded-md p-2 w-full placeholder:text-neutral-600 mt-2 focus:ring-2 ring-neutral-500 outline-none text-neutral-400 font-Intermedium "
              type="text"
              placeholder="Your email"
              name=""
              id=""
            />
            <button className="bg-neutral-800 p-2 rounded-md mt-2 w-full text-neutral-200 font-Intermedium">
              Subscribe
            </button>
          </form>
        </div>
